...
public class JooneScript 
{
    ...
    private Interpreter getShell() {
        if (jShell == null) {
            ...
            try {
                jShell.eval("import org.org.joone.engine.*;");
                jShell.eval("import org.org.joone.engine.learning.*;");
                jShell.eval("import org.org.edit.*;");
                jShell.eval("import org.org.joone.util.*;");
                jShell.eval("import org.org.joone.net.*;");
                jShell.eval("import org.org.joone.io.*;");
                jShell.eval("import org.org.joone.script.*;");
    ...
    public static void main(String [] args){
        if (args.length == 0) {
            System.out.println("Usage: java org.org.joone.script.JooneScript <script_file>");
        }
        else {
