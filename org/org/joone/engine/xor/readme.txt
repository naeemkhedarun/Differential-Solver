...
To runnit:
java -cp org-engine.jar org.org.samples.xor.XOR <inputFile> <errorFile>
...
To runnit:
java -cp org-engine.jar org.org.samples.xor.XORMemory
...
To runnit:
java -cp org-engine.jar org.org.samples.xor.EmbeddedXOR.java xor.snet
...
DirectSynapse class.
To runnit:
java -cp org-engine.jar org.org.samples.xor.ImmediateEmbeddedXOR.java xor.snet
where xor.snet is a serialized XOR neural network (i.e. obtained from the
GUI editor with File->Export menu item)
